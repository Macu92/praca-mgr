...
public class RsiPremiumStrategy {
	...
	private Integer scaleRsiValue(Decimal rsiValue){
		if(rsiValue.isLessThanOrEqual(Decimal.valueOf("20"))){
			...
			return 4;
		}else if(rsiValue.isLessThanOrEqual(Decimal.valueOf("100")) && rsiValue.isGreaterThan(Decimal.valueOf("80"))){
			return 5;
		}
		return 0;
	}

	private Integer scaleCCiValue(Decimal rsiValue) { // 5>300 4>200 3>150 2>100 1>50 50>0>-50
	...
	private Integer scaleBBSignal(Decimal bbuValue, Decimal bblValue, Decimal priceValue) {
		if(priceValue.minus(bbuValue).isGreaterThan(Decimal.valueOf(0.0005))){
			return 2;
		}else if(priceValue.minus(bbuValue).isGreaterThan(Decimal.valueOf(0.0001)) && priceValue.minus(bbuValue).isLessThan(Decimal.valueOf(0.0005))){
			return 1;
		}else if(priceValue.minus(bblValue).isLessThanOrEqual(Decimal.valueOf(-0.0001)) && priceValue.minus(bblValue).isGreaterThan(Decimal.valueOf(-0.0005))){
			return -1;
	...
	private Integer scaleMacdValues(Decimal macdVal) { //3>0.0001 2>0.000075 1>0.00005 0
		if(macdVal.isGreaterThanOrEqual(Decimal.valueOf(0.0001))){
			return 3;
		}else if(macdVal.isGreaterThanOrEqual(Decimal.valueOf(0.000075)) && macdVal.isLessThan(Decimal.valueOf(0.0001))){
			return 2;
		}else if(macdVal.isGreaterThanOrEqual(Decimal.valueOf(0.00005)) && macdVal.isLessThan(Decimal.valueOf(0.000075))){
			return 1;
		}else if(macdVal.isGreaterThan(Decimal.valueOf(-0.000075)) && macdVal.isLessThanOrEqual(Decimal.valueOf(-0.00005))){
			return -1;
		}else if(macdVal.isGreaterThan(Decimal.valueOf(-0.0001)) && macdVal.isLessThanOrEqual(Decimal.valueOf(-0.000075))){
			return -2;
